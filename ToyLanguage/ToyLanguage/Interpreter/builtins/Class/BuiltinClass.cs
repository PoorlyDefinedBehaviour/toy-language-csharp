...
{
    internal class BuiltinClass : ICallable<BuiltinClass>
    {
        ...
        [Obsolete]
        public BuiltinClass Call(Interpreter interpreter, object[] args)
        {
            var instance = new BuiltinClass(name, superclass.Call(interpreter, args), methods, staticMethods, true);
